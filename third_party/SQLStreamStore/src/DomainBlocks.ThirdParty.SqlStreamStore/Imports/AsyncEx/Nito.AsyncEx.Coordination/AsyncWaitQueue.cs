...
using DomainBlocks.ThirdParty.SqlStreamStore.Imports.AsyncEx.Nito.AsyncEx.Tasks;
using DomainBlocks.ThirdParty.SqlStreamStore.Imports.AsyncEx.Nito.Collections.Deque;

namespace DomainBlocks.ThirdParty.SqlStreamStore.Imports.AsyncEx.Nito.AsyncEx.Coordination
{
    /// <summary>
